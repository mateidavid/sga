...
#define MAKE_GETTER_SECTION_BE_IT(Z, I, AUX) \
    SECTION("getter: " BOOST_PP_STRINGIZE(GETTER(I)))   \
    { \
    CHECK( min_of(AUX.begin(), AUX.end(), GETTER(I)) == AUX.begin() + 2 ); \
    }

#define MAKE_CONTAINER_SECTION_BE_IT(Z, N, _) \
...
#define MAKE_GETTER_SECTION_RG_IT(Z, I, AUX) \
    SECTION("getter: " BOOST_PP_STRINGIZE(GETTER(I)))   \
    { \
    CHECK( FCN(AUX, GETTER(I)) == RES(AUX) ); \
    }

#define MAKE_CONTAINER_SECTION_RG_IT(Z, N, _) \
    SECTION("container: " BOOST_PP_STRINGIZE(CONTAINER(N)))  \
    { \
...
#define MAKE_GETTER_SECTION_BE_VAL(Z, I, AUX) \
    SECTION("getter: " BOOST_PP_STRINGIZE(GETTER(I)))   \
    { \
    CHECK( min_value_of(AUX.begin(), AUX.end(), GETTER(I)) == 6 ); \
    }

#define MAKE_CONTAINER_SECTION_BE_VAL(Z, N, _) \
    SECTION("container: " BOOST_PP_STRINGIZE(CONTAINER(N)))  \
    { \
...
// range, return value
#define MAKE_GETTER_SECTION_RG_VAL(Z, I, AUX) \
    SECTION("getter: " BOOST_PP_STRINGIZE(GETTER(I)))   \
    { \
    CHECK( FCN(AUX, GETTER(I)) == RES(AUX) ); \
    }

#define MAKE_CONTAINER_SECTION_RG_VAL(Z, N, _) \
    SECTION("container: " BOOST_PP_STRINGIZE(CONTAINER(N)))  \
    { \
